...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[WebCoordinator]
#     EXE_FILES => [q[script/webcoordinator_cgi.pl], q[script/webcoordinator_create.pl], q[script/webcoordinator_fastcgi.pl], q[script/webcoordinator_server.pl], q[script/webcoordinator_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[WebCoordinator]
#     NO_META => q[1]
#     PREREQ_PM => { namespace::autoclean=>q[0], Catalyst::Plugin::Static::Simple=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Plugin::ConfigLoader=>q[0], Git::Wrapper=>q[0], Catalyst::Action::RenderView=>q[0], Test::More=>q[0.88], Config::General=>q[0], Catalyst::Runtime=>q[5.90017], Moose=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
...
MAKE = make
FULLEXT = WebCoordinator
BASEEXT = WebCoordinator
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/WebCoordinator.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/webcoordinator_cgi.pl \
...
MAN3PODS = lib/WebCoordinator.pm \
...
TO_INST_PM = lib/WebCoordinator.pm \
	lib/WebCoordinator/Controller/Root.pm \
	lib/WebCoordinator/Model/TestRunData.pm \
	lib/WebCoordinator/View/TT.pm
...
DISTNAME = WebCoordinator
DISTVNAME = WebCoordinator-0.01
...
EXE_FILES = script/webcoordinator_cgi.pl script/webcoordinator_create.pl script/webcoordinator_fastcgi.pl script/webcoordinator_server.pl script/webcoordinator_test.pl

pure_all :: $(INST_SCRIPT)/webcoordinator_test.pl $(INST_SCRIPT)/webcoordinator_create.pl $(INST_SCRIPT)/webcoordinator_server.pl $(INST_SCRIPT)/webcoordinator_cgi.pl $(INST_SCRIPT)/webcoordinator_fastcgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/webcoordinator_test.pl $(INST_SCRIPT)/webcoordinator_create.pl \
	  $(INST_SCRIPT)/webcoordinator_server.pl $(INST_SCRIPT)/webcoordinator_cgi.pl \
	  $(INST_SCRIPT)/webcoordinator_fastcgi.pl 

$(INST_SCRIPT)/webcoordinator_test.pl : script/webcoordinator_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/webcoordinator_test.pl
	$(CP) script/webcoordinator_test.pl $(INST_SCRIPT)/webcoordinator_test.pl
	$(FIXIN) $(INST_SCRIPT)/webcoordinator_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/webcoordinator_test.pl

$(INST_SCRIPT)/webcoordinator_create.pl : script/webcoordinator_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/webcoordinator_create.pl
	$(CP) script/webcoordinator_create.pl $(INST_SCRIPT)/webcoordinator_create.pl
	$(FIXIN) $(INST_SCRIPT)/webcoordinator_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/webcoordinator_create.pl

$(INST_SCRIPT)/webcoordinator_server.pl : script/webcoordinator_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/webcoordinator_server.pl
	$(CP) script/webcoordinator_server.pl $(INST_SCRIPT)/webcoordinator_server.pl
	$(FIXIN) $(INST_SCRIPT)/webcoordinator_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/webcoordinator_server.pl

$(INST_SCRIPT)/webcoordinator_cgi.pl : script/webcoordinator_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/webcoordinator_cgi.pl
	$(CP) script/webcoordinator_cgi.pl $(INST_SCRIPT)/webcoordinator_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/webcoordinator_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/webcoordinator_cgi.pl

$(INST_SCRIPT)/webcoordinator_fastcgi.pl : script/webcoordinator_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/webcoordinator_fastcgi.pl
	$(CP) script/webcoordinator_fastcgi.pl $(INST_SCRIPT)/webcoordinator_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/webcoordinator_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/webcoordinator_fastcgi.pl
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/model_TestRunData.t t/view_TT.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>wolf</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Runtime" VERSION="5.90017" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Config::General" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Git::Wrapper" />' >> $(DISTNAME).ppd
